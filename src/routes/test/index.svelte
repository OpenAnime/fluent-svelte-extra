...
<PageSection>
		...
		>
			...
			<svelte:fragment slot="flyout">
				<SegmentedControl bind:value={segmentedControlValue}>
					<SegmentedControlButton value="chocolate">
						...
						Chocolate</SegmentedControlButton
					>
					<SegmentedControlButton value="vanilla">Vanilla</SegmentedControlButton>
					<SegmentedControlButton value="strawberry" disabled
						>Strawberry</SegmentedControlButton
					>
				</SegmentedControl>
			</svelte:fragment>
			<svelte:fragment slot="footer">
	...
	<div class="showcase-group">
		<SegmentedControl bind:value={segmentedControlValue}>
			...
			>
			<SegmentedControlButton value="vanilla">Vanilla</SegmentedControlButton>
			<SegmentedControlButton value="strawberry" disabled>Strawberry</SegmentedControlButton>
		</SegmentedControl>
	</div>
</PageSection>
